...
class FileTest extends TestCase
{
    ...
    public function testFromArray(): void
    {
        ...
        self::assertSame($data['id'], $file->getId());
        self::assertSame($data['name'], $file->getName());
        self::assertSame($data['originalName'], $file->getOriginalName());
        self::assertSame($data['mimeType'], $file->getMimeType());
        self::assertSame($data['size'], $file->getSize());
        self::assertSame($data['sha1Checksum'], $file->getSha1Checksum());
    }
