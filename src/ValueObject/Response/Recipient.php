...
use DigitalCz\DigiSign\ValueObject\Response\Recipient\RecipientEnvelope;
...
class Recipient
{
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            $data['status'],
            $data['role'],
            RecipientEnvelope::fromArray($data['envelope']),
    ...
    public function getEnvelope(): RecipientEnvelope
    {
